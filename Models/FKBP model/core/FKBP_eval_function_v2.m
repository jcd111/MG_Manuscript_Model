function y = FKBP_eval_function_v2(obj)
...
% for different KD values.
    ...
    % Setting KD1 based on P name
    % obj.parameters.KD1 = obj.parameters.(append("KD1_",P_name));
    % Setting KD2 based on G name and P name
    obj.parameters.KD2 = obj.parameters.(append("KD2_",G_name,"_",P_name));
    % Setting KD1 based on G name
    obj.parameters.KD1 = obj.parameters.(append("KD1_",G_name));
...
% Function calculating the equations that need to be solved for the model.
    ...
    % A1 = (1 + E/KD1)*(E/(KD1*KD2));
    % A2 = (1 + E/KD1)*(E/(KD1*KD2));
    % B1 = (1 + E/KD1)*(1 + E/KD1) + (Pt - Gt)*(E/(KD1*KD2));
    % B2 = (1 + E/KD1)*(1 + E/KD1) + (Gt - Pt)*(E/(KD1*KD2));
    % C1 = -(1 + E/KD1)*Gt;
    % C2 = -(1 + E/KD1)*Pt;

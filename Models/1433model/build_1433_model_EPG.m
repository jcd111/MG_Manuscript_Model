...
[parameters, bounds, parameter_names] = initialize_CF1433_parameters();

%% Setting  eval function

eval_function = @(obj,tspan) CF1433_eval_function_EPG(obj);
...
save('Models/1433model/1433model_v1_EPG','model')

%%
load('1433model_v1_EPG.mat')

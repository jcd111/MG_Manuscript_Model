...
[parameters, bounds, parameter_names] = initialize_CF1433_coop_parameters_v2();

%% Setting  eval function

eval_function = @(obj,tspan) CF1433_coop_eval_function_v2(obj);
...
save('Models/1433model/1433_coop_model_v2','model')

%%
load('1433_coop_model_v2.mat')
model.parameters.G_name = "CRAF01";
model.parameters.P_namse = "CRAF";

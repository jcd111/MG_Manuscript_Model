function [parameters, bounds, parameter_names] = initialize_CF1433_coop_parameters_v2()
% Function for setting parameters and bounds for simple equilibrium model
    ...
    % Units: nM
    % Source: estimated
    parameters.EP_ratio = 1;
    bounds.EP_ratio_bounds = [1 500];
